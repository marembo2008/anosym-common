...
public enum Currency {
    ...
    EUR("Euro", "€",
        ...
        Country.LUXEMBOURG, Country.MALTA, Country.MONACO, Country.MONTENEGRO, Country.NETHERLANDS, Country.PORTUGAL,
        Country.SAN_MARINO, Country.SLOVAKIA, Country.SLOVENIA, Country.SPAIN, Country.HOLY_SEE_VATICAN_CITY_,
        Country.SWITZERLAND), // We know for sure Switzerland accepts EUR, albeit its not a member of the EU.
    ...
    KES("Kenyan Shilling", "KES", Country.KENYA),

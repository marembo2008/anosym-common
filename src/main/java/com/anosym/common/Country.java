...
public enum Country {
    ...
    private static final List<Country> EUROPEAN_COUNTRIES = ImmutableList.of(
            ALBANIA, ANDORRA, ARMENIA, AUSTRIA, AZERBAIJAN, BELARUS, BELGIUM, BOSNIA_AND_HERZEGOVINA, BULGARIA, CROATIA, CYPRUS, CZECH_REPUBLIC,
            DENMARK, ESTONIA, FINLAND, FRANCE, GEORGIA, GERMANY, GREECE, HUNGARY, ICELAND, IRELAND, ITALY, KAZAKHSTAN, KOSOVO, LATVIA, LIECHTENSTEIN,
            LITHUANIA, LUXEMBOURG, MACEDONIA, MALTA, MOLDOVA, MONACO, MONTENEGRO, NETHERLANDS, NORWAY, POLAND, PORTUGAL, ROMANIA, RUSSIA, SAN_MARINO,
            SERBIA, SLOVAKIA, SLOVENIA, SPAIN, SWEDEN, SWITZERLAND, TURKEY, UKRAINE, UNITED_KINGDOM
    );

    private static final List<Country> EUROPEAN_UNION_COUNTRIES = ImmutableList.of(
    ...
    private static final List<Country> AFRICAN_COUNTRIES = ImmutableList.of(
            ALGERIA, ANGOLA, BENIN, BOTSWANA, BURKINA_FASO, BURUNDI, CAPE_VERDE, CAMEROON, CENTRAL_AFRICAN_REPUBLIC, CHAD, COMOROS,
            REPUBLIC_OF_THE_CONGO, DEMOCRATIC_REPUBLIC_OF_THE_CONGO, IVORY_COAST, DJIBOUTI, EGYPT, EQUATORIAL_GUINEA, ERITREA, ETHIOPIA, GABON, GAMBIA,
            GHANA, GUINEA, GUINEA_BISSAU, KENYA, LESOTHO, LIBERIA, LIBYA, MADAGASCAR, MALAWI, MALI, MAURITANIA, MAURITIUS, MOROCCO, MOZAMBIQUE,
            NAMIBIA, NIGER, NIGERIA, RWANDA, SAO_TOME_AND_PRINCIPE, SENEGAL, SEYCHELLES, SIERRA_LEONE, SOMALIA, SOUTH_AFRICA, SOUTH_SUDAN, SUDAN,
